 ...
 */
public class LoginView extends AppCompatActivity implements LoaderCallbacks<Cursor>, BaseLoginView {
    ...
    private TextView mRegisterTextBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegisterTextBtn = findViewById(R.id.tv_register_textbtn);
        mRegisterTextBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    @Override
    public void showLoadingState(boolean visibility) {
